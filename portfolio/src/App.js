            ...
            <div className="App">
                ...
                <header className="App-header">
                    <div className="header-content">
                        ...
                        >
                            <h1>
                                DREW <span id="last-name">JOHNSON</span>
                            </h1>
                        </motion.div>
                        <div className="change-text">
                            {this.state.words[this.state.selected]}
                        </div>
                        <div className="logos">
                            <a
                                href="https://www.linkedin.com/in/drew-johnson-99ab34171/"
                                target="_blank"
                    ...
                    <motion.hr
                        animate={{ width: ["0%", "30%"], duration: 5 }}
                    />
                    <motion.hr
                        className="vertical-line"
                        animate={{ height: [1, 55], duration: 5 }}
                    />
                    <ul className="tabs">
                        <li
                            onClick={() => {
                                this.OpenModal("B_aboutMeOpen");
                            }}
                        >
                            <AnimatedBtn title="About Me" />
                        </li>
                        <li onClick={() => this.OpenModal("B_ProjectsOpen")}>
                            <AnimatedBtn title="Projects" />
                        </li>
                        <li onClick={() => this.OpenModal("B_ContactOpen")}>
                            <AnimatedBtn title="Contact" />
                        </li>
                    </ul>
                </header>
